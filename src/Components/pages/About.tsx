...
const About = () => {  return ( 
      ...
      <p className='dark:text-white text-4xl font-bold tracking-tight border-b border-b-[hsl(219_44%_92%/1)] p-4'>About <span className='text-white bg-blue-500 p-1 rounded-sm'>Us</span></p>
