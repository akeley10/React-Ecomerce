  ...
  return (
    <>
     ...
     <div className='dark:bg-[#272935] flex flex-col lg:flex-row flex-1'>
      <img className='h-80 w-80 m-auto lg:h-100 lg:w-130 lg:ml-50 lg:mr-10 object-cover rounded-xl' src={product1}></img> 
      <div className='flex flex-col'>
      <h1 className='dark:text-white mt-5 lg:mt-0 text-3xl ml-10 pb-5 font-bold'>Avant-Garde Lamp</h1>
      ...
      Add to cart
     </button>  :  <a className='h-10 w-20 p-1 m-auto text-center  text-white text-xl bg-[#463aa1] rounded-lg' href="https://react-ecomerce10.netlify.app/form">
      Login</a> }   
      </div>    
     </div>
    <Outlet />
