  ...
  return (
    <>
     ...
     <div className='dark:bg-[#272935] flex flex-col lg:flex-row flex-1'>
      ...
      <h1 className='dark:text-white mt-5 lg:mt-0 text-3xl ml-10 pb-5 font-bold'>Comfy Bed</h1>
      ...
      <button className='text-xs w-30 text-white font-bold uppercase bg-[#463aa1] rounded-lg p-3 mt-5 lg:mt-10 ml-10 cursor-pointer' onClick={() => product && addToCart(product)}>Add to bag</button>
      </div>    
     </div>
    <Outlet />
    </>
