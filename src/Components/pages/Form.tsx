const Form = () => {
  return (
    ...
    <div className="w-full flex justify-center items-center">
      <form className="card w-100 content-center p-8 bg-base-100 shadow-lg flex flex-col gap-y-4 mt-50">
        <h2 className="text-center text-3xl font-bold mb-5 mt-5">Login</h2>
        <div className="flex flex-col text-center">
        <label className="text-2xs text-left">Email</label>
        <input className="border border-[#394e6a33] p-2 mb-5 rounded-xl" type="email"></input>
        <label className="text-2xs text-left">Password</label>
        <input className="border border-[#394e6a33] p-2 mb-5 rounded-xl" type="text"></input>
