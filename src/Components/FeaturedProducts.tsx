  ...
  return (
   ...
   <div className='lg:p-10'>
       ...
       {Products.map((product) => (
            <div className='w-50 md:w-100 p-4 md:p-8 bg-auto rounded-md shadow-xl cursor-pointer' key={product.id}>
              <img className=' h-auto md:h-60 w-100 rounded-lg object-cover' src={product.img} alt={product.title} />
